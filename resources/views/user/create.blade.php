...
@section('content')
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
            <form action="{{url('/users/'.$user->id)}}" class="reg-page" method="post" name="adduser" id="adduser" >
                {{csrf_field()}}
                <div class="input-group margin-bottom-20">
                    ...
                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                    <input type="text" placeholder="Họ tên" class="form-control" id ='username' name ='username' >
                </div>
                <div align='center'>
